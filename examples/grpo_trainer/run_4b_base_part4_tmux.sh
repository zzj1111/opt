#!/bin/bash
# ==============================================================================
# Part 4/4: Qwen3-4B-Base Layers 27-35 on NuminaMath-CoT
# ==============================================================================
...
if [[ -z "${TMUX:-}" ]] && [[ "$NO_TMUX" == "false" ]]; then
    TMUX_SESSION="4b_p4_$(date +%m%d_%H%M)"
...
TOTAL=${#LAYERS[@]}
echo "============================================================"
echo "  Part 4/4: $MODEL_SHORT — Layers 27-35 ($TOTAL exp)"
...
DUMMY_RUN_NAME="dummy_4b_p4_$(hostname)_$(date +%m%d_%H%M)" python3 "$SCRIPT_DIR/dummy_gpu_hold.py"
